...
class TicketCard extends StatelessWidget {
  ...
  const TicketCard({Key? key, this.busnumber,this.start_location,this.Destination,this.report_time,this.departure_time,this.seats_left,this.price}) : super(key: key);
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: ElevatedButton(
                                        onPressed: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => SeatSelectPage()));
                                        },
